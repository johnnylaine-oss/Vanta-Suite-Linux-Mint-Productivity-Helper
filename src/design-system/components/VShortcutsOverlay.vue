...
const sections = [
  {
    name: 'Global',
    items: [
      { label: 'Open Command Palette', keys: ['Ctrl', 'Space'] },
      { label: 'Keyboard Shortcuts', keys: ['Ctrl', 'K', 'S'] },
      { label: 'Toggle Quake Terminal', keys: ['Ctrl', '`'] },
      { label: 'Start Onboarding Tour', keys: ['Ctrl', 'Shift', '?'] },
  ...
  },
  {
    name: 'Navigation',
    items: [
      { label: 'Favorites', keys: ['Ctrl', '1'] },
      { label: 'Terminal', keys: ['Ctrl', '2'] },
      { label: 'AI Assistant', keys: ['Ctrl', '3'] },
      { label: 'Clipboard', keys: ['Ctrl', '4'] },
      { label: 'Reminders', keys: ['Ctrl', '5'] },
      { label: 'Notifications', keys: ['Ctrl', '6'] },
      { label: 'Workflows', keys: ['Ctrl', '7'] },
      { label: 'Settings', keys: ['Ctrl', '8'] },
    ],
  },
  {
    name: 'Terminal',
    items: [
      { label: 'New Tab', keys: ['Ctrl', 'Shift', 'T'] },
      { label: 'Close Tab', keys: ['Ctrl', 'Shift', 'W'] },
  ...
  },
  {
    name: 'Clipboard',
    items: [
      { label: 'Pin Item', keys: ['Ctrl', 'P'] },
      { label: 'Delete Item', keys: ['Delete'] },
      { label: 'Copy Selected', keys: ['Enter'] },
      { label: 'Search History', keys: ['Ctrl', 'F'] },
    ],
  },
  {
    name: 'Workflows',
    items: [
      { label: 'Run Workflow', keys: ['Ctrl', 'R'] },
